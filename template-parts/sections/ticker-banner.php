<?php $lang = pll_current_language(); // Récupère la langue active
...
<?php } else { ?>
    ...
    <div class="ticker-container">
        <div class="ticker-content">
            ...
            <span>Châtel-Saint-Denis</span>
            <span class="star-icon"></span>
            <span class="ticker-outline">20 et 21 mars 2026</span>
            <span class="star-icon"></span>
            <span>Moteur Action !</span>
            <span class="star-icon"></span>
            <span class="ticker-outline">Châtel-Saint-Denis</span>
            <span class="star-icon"></span>
            <span>20 et 21 mars 2026</span>
            <span class="star-icon"></span>
            <span class="ticker-outline">Moteur Action !</span>
            <span class="star-icon"></span>
            <span>Châtel-Saint-Denis</span>
            <span class="star-icon"></span>
            <span class="ticker-outline">20 et 21 mars 2026</span>
